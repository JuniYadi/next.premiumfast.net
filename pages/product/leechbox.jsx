...
export default function WhatsappGateway() {
    ...
    const head = {
        title: 'Leechbox',
        description: 'Butuh file asli dari .torrent? Leechbox bisa convert file .torrent ke file asli dengan mudah melalui browser dengan direct link download.',
    ...
    const faqs = [
        {
            ...
            "description": "Leechbox adalah aplikasi berbasis web untuk mendownload file torrent dan merubah file torrent menjadi file aslinya."
        },
        {
