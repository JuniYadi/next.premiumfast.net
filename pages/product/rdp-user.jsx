...
export default function WhatsappGateway() {
    ...
    const head = {
        title: 'RDP User',
        description:
            'RDP User sangat cocok bagi anda yang kebutuhan download atau upload ke berbagai host tanpa mengurangi kuota internet anda, Semua koneksi internet dan quota sepenuhnya menggunakan koneksi dari server rdp.',
        keywords:
            'rdp, rdp user, rdp murah, rdp nvme, rdp storage, rdp eropa, rdp ram besar',
    ...
    const featuredLists = [
        ...
        },
        {
            ...
            icon: ['fas', 'terminal'],
            description:
                'Anda mendapatkan hak akses penuh (root atau administrator) ke vps anda.',
        },
        {
            name: 'Virtualizor Control Panel',
            icon: ['fas', 'sliders-h'],
            description:
                'Dengan Virtualizor Control Panel, anda bisa memanage vps anda, mulai dari boot/reboot/ reinstall/ rescue/ dll.',
        },
        {
            name: 'Speed Connection',
            icon: ['fas', 'tachometer-alt'],
            description:
                'Server utama terhubung ke 1 Gbps Port dengan Guarantee 250Mbps In/Out.',
        },
        {
            name: 'Upgrade Available',
            icon: ['fas', 'hdd'],
            description:
                'Anda bisa upgrade server anda dari yang lebih kecil ke lebih besar pada datacenter yang sama, selama produk tersedia.',
        },
        {
            name: 'Unlimited Bandwidth',
            icon: ['fas', 'infinity'],
            description:
                'Tidak perlu khawatir tentang batasan bandwidth, setiap server mendapatkan unlimited bandwidth.',
        },
        {
            name: 'Enterprise Hardware',
            icon: ['fas', 'microchip'],
            description:
                'Kami menggunakan hardware terbaik dari Intel Xeon Series untuk server kami.',
        },
    ];
