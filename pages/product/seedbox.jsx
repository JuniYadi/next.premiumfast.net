...
export default function WhatsappGateway() {
    ...
    const head = {
        title: 'Seedbox',
        description:
            'Seedbox, Fitur dan Fungsi sama seperti Leechbox, hanya berbeda di status download yaitu ketika anda selesai mendownload, maka status akan menjadi Seeding.',
    ...
    const featuredLists = [
        {
            ...
            icon: ['fas', 'clock'],
            description:
                'Produk akan diaktifkan setelah pembayaran diterima, Minimal 10 menit, Maksimal 1x24 Jam.',
        },
        {
            name: 'Easy Access',
            icon: ['fab', 'chrome'],
    ...
    const faqs = [
        {
            ...
            description:
                'Seedbox adalah aplikasi berbasis web untuk mendownload file torrent dan merubah file torrent menjadi file aslinya.',
        },
        {
